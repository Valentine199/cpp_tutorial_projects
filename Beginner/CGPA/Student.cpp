#include "headers/Student.h"
    ...
    void Student::AddCurrentSemester()
    {
    ...
    void Student::CalculateStatistics()
    {
    ...
    void Student::ShowDetailedSemesterInfo(int semesterIndex)
    {
    ...
    void Student::AddSemester(const std::vector<PickedClass>& courses)
    {
        Semesters.push_back(courses);
    }
    float Student::CalculateGPA(const std::vector<PickedClass>& currentSemester)
    {
    ...
    float Student::CalculateCGPA(const std::vector<float>& semesterGPAs)
        {
